...
class Dogecoin extends Component {
    ...
    createWallet = (e) => {
        e.preventDefault()
        var keyPair = bitcoin.ECPair.makeRandom({network: dogecoin});
    ...
    createTransaction = (e) => {
        ...
        var hashURL = `https://api.blockcypher.com/v1/doge/main/addrs/${address}`
            ...
            var keyPair2 = bitcoin.ECPair.fromWIF(privateKey, dogecoin);
    ...
    checkBalance = (e) => {
        ...
        var blockcypherURL = `https://api.blockcypher.com/v1/doge/main/addrs/${address}/balance`
    ...
    render() {
        ...
        return (
            ...
            <form id="transaction">
                <h4>Send Dogecoin!</h4>
                <input id="add" value={add} onChange={this.onChangeAddress} name="add" type="text" placeholder="Recipient's DOGE Address" autoFocus autoComplete="off"></input><br /><br />
                
                <input id="amount" value={amount} onChange={this.onChangeAmount} name="amount" type="text" placeholder="Amount of DOGE to send"></input><br /><br />
